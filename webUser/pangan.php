   ...
   <nav class="navbar navbar-default navbar-transparent navbar-fixed-top" color-on-scroll="200">
    ...
    <div class="section section-small section-get-started">
        <div class="parallax filter">
            <div class="image"
                style="background-image: url('img/head_pangan1.jpg')">
            </div>
            <div class="container">
                <div class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="title-area">
                    ...
                    <a href="form_pangan.php" type="btn btn-primary">Upload Pangan Lokal</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <img src="img/kentang.jpg" class="card-img-top" alt="aaaa">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <img src="img/jagung.jpg" class="card-img-top" alt="aaaa">
                         <div class="card-body" style="padding: 10px;">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <img src="img/ubi.jpg" class="card-img-top" alt="aaaa">
                         <div class="card-body" style="padding: 10px;">
                 ...
                 <div class="col-md-6">
                    <div class="card">
                        <img src="img/pisang.jpg" class="card-img-top" alt="aaaa">
                         <div class="card-body" style="padding: 10px;">
