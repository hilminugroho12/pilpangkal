...
<div class="section section-small section-get-started">
    ...
    <div class="section" id="berita">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    <img src="<?php echo base_url('assets/img/berita1.jpg') ?>" class="artikel" alt="">
                    <div class="card-body">
                ...
                <div class="col-md-3">
                    ...
                    <img src="<?php echo base_url('assets/img/berita2.jpg') ?>" class="artikel" alt="aaaa">
                    <div class="card-body">
                        <h4 class="card-title"><?php echo $row->nama_pangan ?></h3>
