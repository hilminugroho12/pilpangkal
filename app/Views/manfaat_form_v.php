...
<div class="container-fluid">
                 <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Tambah Manfaat</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<?php echo site_url('Manfaat/save') ?>" method="POST">
                                ...
                                <div class="form-group">
                                   <label class="col-md-12">Judul Manfaat</label>
                                    <div class="col-md-12">
                                        <input type="text" name="judul" class="form-control form-control-line" value="<?php if (!empty($dataManfaat)) echo $dataManfaat->judul; ?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Gambar</label>
                                    <div class="col-md-12">
                                        <input type="file" name="foto" class="form-control form-control-line" value="<?php if (!empty($dataManfaat)) echo $dataManfaat->foto; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Deskripsi</label>
                                    <div class="col-md-12">
                                        <textarea rows="5" name="deskripsi" class="form-control form-control-line" value="<?php if (!empty($dataManfaat)) echo $dataManfaat->deskripsi; ?>"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Author</label>
                                    <div class="col-md-12">
                                        <input type="text" name="author" class="form-control form-control-line" value="<?php if (!empty($dataManfaat)) echo $dataManfaat->author; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
