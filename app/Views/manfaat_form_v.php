...
<html lang="en">
    <head>
        ...
        <title>Form Manfaat Pangan Lokal</title>
    </head>
    <body>
        <br> <br>
        <h2 align="center">Form Manfaat Pangan Lokal</h2>
        <div class="container">
            <form action="<?php echo site_url('Manfaat/save'); ?>" method="POST">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Manfaat Pangan Lokal</label>
