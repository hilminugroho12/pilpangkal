          ...
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <img src="<?php echo base_url('assets/img/logo.jpg') ?>" alt="logo" class="logo">
              </div>
              ...
              <form action="#!">
                ...
                <br>
                <p class="login-card-footer-text">Belum punya akun? <a href="#!" class="text-reset"><font color="#854d0a">Register</font></a></p>
            </div>
          </div>
        </div>
      </div>
