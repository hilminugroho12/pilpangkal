...
<div class="container-fluid">
                 <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Tambah Pangan Lokal</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<?php echo site_url('Pangan/save') ?>" method="POST">
                                <div class="form-group">
                                    <label class="col-md-12">Kode Pangan Lokal</label>
                                    <div class="col-md-12">
                                        <input type="text" required name="kode_pangan" class="form-control form-control-line" value="<?php if (!empty($dataPangan)) echo $dataPangan->kode_pangan; ?>"> </div>
